...
export default function Card({username , btnType="visit me"}){
    return(
      ...
      <div className="absolute bottom-4 left-4 text-left">
        ...
        <button className="mt-2 inline-flex cursor-pointer items-center text-sm font-semibold text-white">{btnType} →</button>
      </div>
        </div>
    )
}
